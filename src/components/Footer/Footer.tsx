        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600 dark:text-gray-400">
              © 2024 Global Network. All rights reserved.
            </span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <a href="#" className="text-gray-600 dark:text-white hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors">
              <svg className="h-5 w-5 text-inherit" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
