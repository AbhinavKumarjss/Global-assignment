...
export default function Navbar() {
    ...
    return (
        <nav className=' flex justify-between dark:border-gray-700 rounded-none bg-transparent dark:bg-transparent py-4 sm:px-[15px] px-2'>
            ...
            <button  onClick={logOutHandler}className=" font-medium xl:block xl:flex h-10 px-10 w-10 text-darklink dark:text-white text-base hover:text-primary  hover:bg-lightprimary dark:hover:text-primary dark:hover:bg-darkminisidebar  rounded-full flex justify-center  items-center cursor-pointer">Logout</button>
            </div>
            </div>
        </nav>
    )
